...
procedure RenderText(const str : String; const left, top : integer; const scale : Single = 1; r : Single = 1; g : Single = 1; b : Single = 1);
procedure RenderTextOne(const str : String; const left, top : integer; const scale : Single = 1; r : Single = 1; g : Single = 1; b : Single = 1);
...
begin
  ...
  BindTexture(TT_GLOBAL, FONT_TEXIDX);
end;
...
begin
  StartText();
  RenderText(str, left, top, scale, r, g, b);
  EndText();
end;
